...
TQID: https://experienceleague.adobe.com/XmZ4O-iaq7aoYYXob7PkomeczfEom78g6wOwWcxjLzc
...
>[컨트롤 그룹](https://experienceleague.adobe.com/docs/campaign-classic/using/orchestrating-campaigns/orchestrate-campaigns/marketing-campaign-target.html?lang=ko#defining-a-control-group){target="_blank"}과 [게재 대상 집단을 정의하는 방법](https://experienceleague.adobe.com/docs/campaign-classic/using/sending-messages/key-steps-when-creating-a-delivery/steps-defining-the-target-population.html?lang=ko){target="_blank"}에 대한 자세한 설명은 제품 설명서를 참조하세요
